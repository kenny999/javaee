...
public class KindergartenBean {
	...
	public void saveGarmentValidatedByEJB(@Valid Garment garment) {
		// Shouldnt get here due to bean validation...
		em.persist(garment);		
	}

	public void saveGarmentValidatedByJPA(Garment garment) {
		em.persist(garment);		
	}
