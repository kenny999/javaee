...
public class KindergartenBean {
	...
	public Kindergarten create() {
		...
		addExtraGarmentsToChildElin(childElin);
	...
	private void addExtraGarmentsToChildElin(Child childElin) {
		for(int i=0;i<10000;i++){
			String garmentName = randomName();
			setGarmentToChild(childElin, garmentName);
		}
	}
	...
	public void addGarmentToChildElin() {
		System.out.println("Enter addGarmentToChildElin");
