...
public class KindergartenBean {
	...
	public Kindergarten create() {
		...
		setBorrowedBooksOfChildElin(childElin);
	...
	private void setBorrowedBooksOfChildElin(Child childElin) {
		
		Map<String, String> bBooks = new HashMap<>();
		bBooks.put("Saltkråkan", "Barnbok");
		bBooks.put("Pippi", "Barnbok");
		bBooks.put("Tusen och en natt", "Sagobok");
		bBooks.put("Gonatt mr tom", "Ungdomsbok");
		childElin.setBorrowedBooks(bBooks);
