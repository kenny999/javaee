...
@NamedQuery(name = Child.findChildByNameWithGarments, query = "select c from Child c join fetch c.garments where c.name = :childName"),
})
public class Child {
	
	public static final String findChildByName = "findChildByName";
	public static final String findChildByNameWithGarments = "findChildByNameWithGarments";
