...
import com.kenneth.kindergarten.entities.Guardian;
import com.kenneth.kindergarten.entities.Kindergarten;
import com.kenneth.kindergarten.entities.Parent;
...
public class KindergartenBean {
	...
	public Kindergarten create() {
		...
		addExtraForChildElin(childElin);
	...
	private void addExtraForChildElin(Child childElin) {
		...
		childElin.setParents(parents);
		
		Guardian g = new Guardian();
		g.setName("Torben Wosik");
		g.setAge(66);
		childElin.setGuardian(g);
