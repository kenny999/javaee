...
public class KindergartenJSFBean implements Serializable{
	...
	private int someDigit;

	public int getSomeDigit() {
		return someDigit;
	}

	public void setSomeDigit(int someDigit) {
		this.someDigit = someDigit;
	}
	...
	public void changeSomeDigit(){
		kindergartenBean.changeSomeDigitDuringLock("Elin", someDigit);
	}
