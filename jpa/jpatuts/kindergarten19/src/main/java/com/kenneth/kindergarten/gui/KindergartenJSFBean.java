...
public class KindergartenJSFBean implements Serializable{
	...
	public void doIt(){
		...
		kindergartenBean.setToysForChild("Elin");
		kindergartenBean.setToysForChild("Manda");
		kindergartenBean.setToysForChild("Mille");
		kindergartenBean.setToysForChild("Elis");
	}
