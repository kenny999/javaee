...
@SqlResultSetMapping(name= Child.sqlResultSetMapping1, classes = {
        @ConstructorResult(targetClass = ChildDTO.class,
            columns = {
...
public class Child {
	...
	public static final String sqlResultSetMapping1 = "sqlResultSetMapping1";
