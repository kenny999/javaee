...
@NamedQuery(name = Child.countChildren, query = "select count(c) from Child c"),
@NamedQuery(name = Child.getAllChilds, query = "select c from Child c"),
})
public class Child {
	
	public static final String findChildByName = "findChildByName";

	public static final String countChildren = "countChildren";

	public static final String getAllChilds = "getAllChilds";
