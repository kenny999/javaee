...
public class KindergartenBean {
	...
	public List<ChildDTO> getAllChildsAsDTO() {
		TypedQuery<ChildDTO> query = em.createNamedQuery(Child.getAllChild, ChildDTO.class);
		List<ChildDTO> r = query.getResultList();
		return r;
	}
