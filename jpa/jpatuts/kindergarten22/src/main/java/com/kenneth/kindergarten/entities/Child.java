...
@NamedQuery(name = Child.getAllChild, query = "select new com.kenneth.kindergarten.dto.ChildDTO(c.id, c.name) from Child c"),
})
public class Child {
	
	public static final String findChildByName = "findChildByName";
	public static final String getAllChild = "getAllChild";
