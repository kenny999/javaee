...
@Entity
@NamedQuery(name = Section.findSectionByName, query = "select s from Section s where s.name = :name")
public class Section {
	public static final String findSectionByName = "findSectionByName";
