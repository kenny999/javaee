...
public class KindergartenBean {
	...
	public Section readSectionWithName(String name) {		
		TypedQuery<Section> query = em.createNamedQuery(Section.findSectionByName, Section.class);
		query.setParameter("name", name);
		Section section = query.getSingleResult();
		section.getChilds().size();
		return section;
	}

	public void saveModifiedSection(Section s) {
		em.merge(s);
	}
