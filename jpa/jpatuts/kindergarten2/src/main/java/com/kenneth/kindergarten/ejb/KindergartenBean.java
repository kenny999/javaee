...
public class KindergartenBean {
	...
	private void setLobsToChild(Child childElin) {
		String description = "This is a child and blabla";
		childElin.setDescription(description);
		byte[] picture = new byte[100];
		for(int i=0;i<100;i++){
			picture[i] = 0x08;
		}
		childElin.setPicture(picture);
	}
